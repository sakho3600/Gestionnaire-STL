...
{
    public partial class Ajout_Facture : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query_3 = "insert into facture values (null, @num_contrat, @num_vehicule, @catr, @nombre_km_hr, @tarif_journalier, @tarif_chauffeur, @montant_global, @montant_hors_taxe, @montant_tva, @montant_net, date_facture)";
            ...
            cmd_3.Parameters.AddWithValue("@nombre_km_hr", nombre_km_hr);
