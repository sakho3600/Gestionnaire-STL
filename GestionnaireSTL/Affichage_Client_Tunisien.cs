...
{
    public partial class Affichage_Client_Tunisien : Form
    {
        public Affichage_Client_Tunisien()
        {
            InitializeComponent();
        }

        private void Affichage_Client_Tunisien_Load(object sender, EventArgs e)
        {
