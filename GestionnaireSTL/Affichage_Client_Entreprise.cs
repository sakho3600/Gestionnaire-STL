...
{
    public partial class Affichage_Client_Entreprise : Form
    {
        public Affichage_Client_Entreprise()
        {
            InitializeComponent();
        }

        private void Affichage_Client_Entreprise_Load(object sender, EventArgs e)
        {
            ...
            listView1.Columns.Add("Code Fiscale", 150);
            listView1.Columns.Add("Raison", 150);
